            ...
            .forEach(
                variant -> builder.addCriterion(
                        ...
                        PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(
                            ...
                            Optional.of(
                                EntityPredicate.wrap(
                                    EntityPredicate.Builder.entity().of(EntityType.FROG).subPredicate(EntitySubPredicate.variant(variant.value()))
                                )
                            )
                        )
                    )
            ...
            .forEach(
                entry -> builder.addCriterion(
                        ...
                        TameAnimalTrigger.TriggerInstance.tamedAnimal(
                            EntityPredicate.Builder.entity().subPredicate(EntitySubPredicate.variant(entry.getValue()))
                        )
                    )
            );
        return builder;
