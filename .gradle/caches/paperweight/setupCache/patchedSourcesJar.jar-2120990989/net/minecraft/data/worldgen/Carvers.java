...
public class Carvers {
    ...
    private static ResourceKey<ConfiguredWorldCarver<?>> createKey(String id) {
        return ResourceKey.create(Registries.CONFIGURED_CARVER, new ResourceLocation(id));
    }

    public static void bootstrap(BootstapContext<ConfiguredWorldCarver<?>> carverRegisterable) {
