...
public class ClientboundPlayerInfoUpdatePacket implements Packet<ClientGamePacketListener> {
    ...
    public static ClientboundPlayerInfoUpdatePacket createPlayerInitializing(Collection<ServerPlayer> players, ServerPlayer forPlayer) {
        ...
        final org.bukkit.craftbukkit.v1_20_R3.entity.CraftPlayer bukkitEntity = forPlayer.getBukkitEntity();
    ...
    public static enum Action {
        ...
        UPDATE_DISPLAY_NAME(
            (serialized, buf) -> serialized.displayName = buf.readNullable(FriendlyByteBuf::readComponentTrusted),
            (buf, entry) -> buf.writeNullable(entry.displayName(), FriendlyByteBuf::writeComponent)
        );
