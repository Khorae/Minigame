...
public class ProcessorLists {
    ...
    private static ResourceKey<StructureProcessorList> createKey(String id) {
        return ResourceKey.create(Registries.PROCESSOR_LIST, new ResourceLocation(id));
    }

    private static void register(
        BootstapContext<StructureProcessorList> processorListRegisterable, ResourceKey<StructureProcessorList> key, List<StructureProcessor> processors
    ) {
        processorListRegisterable.register(key, new StructureProcessorList(processors));
    }

    public static void bootstrap(BootstapContext<StructureProcessorList> processorListRegisterable) {
    ...
    private static CappedProcessor trailsArchyLootProcessor(ResourceLocation lootTableId, int limit) {
