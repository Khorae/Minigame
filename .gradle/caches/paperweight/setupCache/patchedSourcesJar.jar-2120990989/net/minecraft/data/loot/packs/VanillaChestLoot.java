...
public class VanillaChestLoot implements LootTableSubProvider {
    ...
    public void generate(BiConsumer<ResourceLocation, LootTable.Builder> exporter) {
        ...
        exporter.accept(BuiltInLootTables.BASTION_BRIDGE, bastionBridgeLootTable());
        exporter.accept(BuiltInLootTables.BASTION_HOGLIN_STABLE, bastionHoglinStableLootTable());
        exporter.accept(BuiltInLootTables.BASTION_OTHER, bastionOtherLootTable());
        exporter.accept(BuiltInLootTables.BASTION_TREASURE, bastionTreasureLootTable());
        exporter.accept(
        ...
        exporter.accept(BuiltInLootTables.ANCIENT_CITY, ancientCityLootTable());
        exporter.accept(
        ...
        exporter.accept(BuiltInLootTables.DESERT_PYRAMID, desertPyramidLootTable());
        exporter.accept(BuiltInLootTables.END_CITY_TREASURE, endCityTreasureLootTable());
        exporter.accept(
        ...
        exporter.accept(BuiltInLootTables.JUNGLE_TEMPLE, jungleTempleLootTable());
        exporter.accept(
        ...
        exporter.accept(BuiltInLootTables.NETHER_BRIDGE, netherBridgeLootTable());
        exporter.accept(BuiltInLootTables.PILLAGER_OUTPOST, pillagerOutpostLootTable());
        exporter.accept(BuiltInLootTables.SHIPWRECK_MAP, shipwreckMapLootTable());
        exporter.accept(BuiltInLootTables.SHIPWRECK_SUPPLY, shipwreckSupplyLootTable());
        exporter.accept(BuiltInLootTables.SHIPWRECK_TREASURE, shipwreckTreasureLootTable());
        exporter.accept(
        ...
        exporter.accept(BuiltInLootTables.STRONGHOLD_CORRIDOR, strongholdCorridorLootTable());
        exporter.accept(
        ...
        exporter.accept(BuiltInLootTables.STRONGHOLD_LIBRARY, strongholdLibraryLootTable());
        exporter.accept(
        ...
        exporter.accept(BuiltInLootTables.WOODLAND_MANSION, woodlandMansionLootTable());
        exporter.accept(
        ...
        exporter.accept(BuiltInLootTables.TRIAL_CHAMBERS_REWARD, LootTable.lootTable());
        exporter.accept(BuiltInLootTables.TRIAL_CHAMBERS_SUPPLY, LootTable.lootTable());
        exporter.accept(BuiltInLootTables.TRIAL_CHAMBERS_CORRIDOR, LootTable.lootTable());
        exporter.accept(BuiltInLootTables.TRIAL_CHAMBERS_ENTRANCE, LootTable.lootTable());
        exporter.accept(BuiltInLootTables.TRIAL_CHAMBERS_INTERSECTION, LootTable.lootTable());
        exporter.accept(BuiltInLootTables.TRIAL_CHAMBERS_INTERSECTION_BARREL, LootTable.lootTable());
        exporter.accept(BuiltInLootTables.TRIAL_CHAMBERS_CHAMBER_DISPENSER, LootTable.lootTable());
        exporter.accept(BuiltInLootTables.TRIAL_CHAMBERS_CORRIDOR_DISPENSER, LootTable.lootTable());
        exporter.accept(BuiltInLootTables.TRIAL_CHAMBERS_WATER_DISPENSER, LootTable.lootTable());
        exporter.accept(BuiltInLootTables.TRIAL_CHAMBERS_CORRIDOR_POT, LootTable.lootTable());
        spawnerLootTables(exporter);
    }

    public static void spawnerLootTables(BiConsumer<ResourceLocation, LootTable.Builder> exporter) {
        exporter.accept(BuiltInLootTables.SPAWNER_TRIAL_CHAMBER_KEY, LootTable.lootTable());
        exporter.accept(BuiltInLootTables.SPAWNER_TRIAL_CHAMBER_CONSUMABLES, LootTable.lootTable());
    }
