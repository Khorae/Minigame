...
public class GameTestServer extends MinecraftServer {
    ...
    public static GameTestServer create(
        Thread thread, LevelStorageSource.LevelStorageAccess session, PackRepository resourcePackManager, Collection<GameTestBatch> batches, BlockPos pos
    ) {
        if (batches.isEmpty()) {
    ...
    private void startTests(ServerLevel world) {
        ...
        Collection<GameTestInfo> collection = GameTestRunner.runTestBatches(this.testBatches, blockPos, Rotation.NONE, world, GameTestTicker.SINGLETON, 8);
