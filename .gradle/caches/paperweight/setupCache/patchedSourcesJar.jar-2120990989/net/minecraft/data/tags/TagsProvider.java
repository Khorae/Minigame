...
public abstract class TagsProvider<T> implements DataProvider {
    ...
    protected TagsProvider(
        ...
        this.pathProvider = output.createPathProvider(PackOutput.Target.DATA_PACK, TagManager.getTagDir(registryRef));
    ...
    public CompletableFuture<?> run(CachedOutput writer) {
        ...
        return this.createContentsProvider()
            ...
            .thenCombineAsync(this.parentProvider, (lookup, parent) -> new CombinedData<>(lookup, (TagsProvider.TagLookup<T>)parent))
            .thenCompose(
                info -> {
                            ...
                            .map(
                                entry -> {
                                    ...
                                    if (!list2.isEmpty()) {
                                        ...
                                        JsonElement jsonElement = TagFile.CODEC
                                            .encodeStart(JsonOps.INSTANCE, new TagFile(list, false))
