...
public class GameTestRegistry {
    ...
    public static Collection<TestFunction> getTestFunctionsForClassName(String testClass) {
        return TEST_FUNCTIONS.stream().filter(testFunction -> isTestFunctionPartOfClass(testFunction, testClass)).collect(Collectors.toList());
    }
    ...
    public static Optional<TestFunction> findTestFunction(String structurePath) {
        return getAllTestFunctions().stream().filter(testFunction -> testFunction.getTestName().equalsIgnoreCase(structurePath)).findFirst();
    }
