...
public class UpdateOneTwentyOneRegistries {
    ...
    public static CompletableFuture<RegistrySetBuilder.PatchedRegistries> createLookup(CompletableFuture<HolderLookup.Provider> registriesFuture) {
        return RegistryPatchGenerator.createLookup(registriesFuture, BUILDER);
    }
}
