...
public enum ConnectionProtocol {
    ...
    public static class CodecData<T extends PacketListener> implements BundlerInfo.Provider {
        ...
        Int2ObjectMap<Class<? extends Packet<?>>> packetsByIds() {
            ...
            this.packetSet.classToId.forEach((packet, id) -> int2ObjectMap.put(id.intValue(), (Class<? extends Packet<?>>)packet));
    ...
    static class PacketSet<T extends PacketListener> {
        ...
        final Object2IntMap<Class<? extends Packet<? super T>>> classToId = Util.make(new Object2IntOpenHashMap<>(), map -> map.defaultReturnValue(-1));
        ...
        public <P extends BundlePacket<T>> ConnectionProtocol.PacketSet<T> withBundlePacket(
            ...
            if (this.bundlerInfo != BundlerInfo.EMPTY) {
                ...
                this.addPacket(BundleDelimiterPacket.class, buf -> bundleDelimiterPacket);
