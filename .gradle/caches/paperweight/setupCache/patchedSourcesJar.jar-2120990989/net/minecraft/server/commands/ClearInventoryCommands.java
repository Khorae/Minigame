    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher, CommandBuildContext commandRegistryAccess) {
        dispatcher.register(
            Commands.literal("clear")
                ...
                .executes(context -> clearInventory(context.getSource(), Collections.singleton(context.getSource().getPlayerOrException()), stack -> true, -1))
                .then(
                    Commands.argument("targets", EntityArgument.players())
                        .executes(context -> clearInventory(context.getSource(), EntityArgument.getPlayers(context, "targets"), stack -> true, -1))
                        .then(
