...
public class GameTestInfo {
        ...
        if (!this.isDone()) {
            ...
            if (this.chunksLoaded
                ...
                if (this.ticksToWaitForChunkLoading > 0) {
                    ...
                    if (this.isDone()) {
                        if (this.error != null) {
                            this.listeners.forEach(listener -> listener.testFailed(this));
                        } else {
                            this.listeners.forEach(listener -> listener.testPassed(this));
                        }
                    }
                }
            }
    ...
    public void prepareTestStructure(BlockPos pos) {
        this.structureBlockEntity = StructureUtils.prepareTestStructure(this, pos, this.getRotation(), this.level);
