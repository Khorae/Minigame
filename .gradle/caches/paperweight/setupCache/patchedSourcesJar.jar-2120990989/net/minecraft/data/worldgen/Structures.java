...
public class Structures {
    public static Structure.StructureSettings structure(
        HolderSet<Biome> biomes, Map<MobCategory, StructureSpawnOverride> spawns, GenerationStep.Decoration featureStep, TerrainAdjustment terrainAdaptation
    ) {
        return new Structure.StructureSettings(biomes, spawns, featureStep, terrainAdaptation);
    }

    private static Structure.StructureSettings structure(HolderSet<Biome> biomes, GenerationStep.Decoration featureStep, TerrainAdjustment terrainAdaptation) {
    ...
    public static void bootstrap(BootstapContext<Structure> structureRegisterable) {
        ...
        structureRegisterable.register(
            BuiltinStructures.IGLOO, new IglooStructure(structure(holderGetter.getOrThrow(BiomeTags.HAS_IGLOO), TerrainAdjustment.NONE))
        );
        structureRegisterable.register(
