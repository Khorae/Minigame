...
public class VanillaAdventureAdvancements implements AdvancementSubProvider {
    ...
    public void generate(HolderLookup.Provider lookup, Consumer<AdvancementHolder> exporter) {
        ...
        createAdventuringTime(exporter, advancementHolder2, MultiNoiseBiomeSourceParameterList.Preset.OVERWORLD);
    ...
    protected static void createAdventuringTime(
        Consumer<AdvancementHolder> exporter, AdvancementHolder parent, MultiNoiseBiomeSourceParameterList.Preset preset
    ) {
